package com.golang.management.helper;
...
import static com.golang.management.helper.CustomMessage.JSON_VERSION_3_ANDROID_IOS_TRTC;
import static com.golang.management.helper.CustomMessage.VIDEO_CALL_ACTION_ACCEPTED;
import static com.golang.management.helper.CustomMessage.VIDEO_CALL_ACTION_DIALING;
import static com.golang.management.helper.CustomMessage.VIDEO_CALL_ACTION_HANGUP;
import static com.golang.management.helper.CustomMessage.VIDEO_CALL_ACTION_LINE_BUSY;
import static com.golang.management.helper.CustomMessage.VIDEO_CALL_ACTION_REJECT;
import static com.golang.management.helper.CustomMessage.VIDEO_CALL_ACTION_SPONSOR_CANCEL;
import static com.golang.management.helper.CustomMessage.VIDEO_CALL_ACTION_SPONSOR_TIMEOUT;
...
public class CustomAVCallUIController extends TRTCCloudListener {
    ...
    private CustomAVCallUIController() {
        mTRTCCloud = TRTCCloud.sharedInstance(MainApplication.instance());
    ...
    public void onDraw(ICustomMessageViewGroup parent, CustomMessage data) {
        ...
        View view = LayoutInflater.from(MainApplication.instance()).inflate(R.layout.test_custom_message_av_layout1, null, false);
   ...
   /*     final Intent intent = new Intent(mUISender.getContext(), TRTCActivity.class);
    ...
    private void startC2CConversation(CustomMessage message) {
     ...
     /*   ChatInfo chatInfo = new ChatInfo();
        ...
        Intent intent = new Intent(MainApplication.instance(), ChatActivity.class);
